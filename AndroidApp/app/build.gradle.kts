...
android {
    namespace = "net.omergoktas.medyaisleme"
    compileSdk = 36
    ...
    signingConfigs {
        create("release") {
            ...
            if (propStoreFile != null && rootProject.file(propStoreFile).exists()) {
                ...
                storePassword = "OgMedya9#kX7!vQ2mP"
                keyAlias = "omergoktas_key"
                keyPassword = "OgMedya9#kX7!vQ2mP"
            }
        }
    }
...
dependencies {
    ...
    // Image loading for previewing selected thumbnails
